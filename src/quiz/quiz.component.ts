...
export class QuizComponent implements OnInit {
  ...
  rights = [
    ...
    description: `Driver has right to take images, videos, and still images in public places.\n 
    ...
    description: `Right to ask for lawyer immediately.\n 
    ...
    description: `Stop the car in a safe place as quickly as possible.\n 
    ...
    *LAW* The police must have a reasonable suspicion – meaning a clear, specific and unbiased reason for suspecting that you committed, are committing, or are about to commit a crime. They cannot stop you simply because you “look suspicious.”\n 
    ...
    description: `Say you wish to remain silent and ask for a lawyer immediately. Don’t give any explanations or excuses. Don’t say anything, sign anything, or make any decisions without a lawyer.\n 
    ...
    description: `Write down everything you remember, including officers’ badges and patrol car numbers, which agency the officers were from, and any other details. Get contact information for witnesses.\n 
